...
def prepare_dataloader(data_aug_param,df, trn_idx, val_idx, data_root=r'H:\cassava\train_images\\'):
    from catalyst.data.sampler import BalanceClassSampler

    train_ = df.loc[trn_idx, :].reset_index(drop=True)
    valid_ = df.loc[val_idx, :].reset_index(drop=True)

    train_ds = CassavaDataset(train_, data_root, transforms=get_train_transforms(data_aug_param), output_label=True,
    ...
    try:
        ...
        for fold, (trn_idx, val_idx) in enumerate(folds):
            ...
            if fold == fold_num:
                ...
                train_loader, val_loader = prepare_dataloader(tuner_params,train, trn_idx, val_idx,
